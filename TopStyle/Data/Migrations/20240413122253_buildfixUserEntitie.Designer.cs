...
namespace TopStyle.Data.Migrations
{
    ...
    [Migration("20240413122253_buildfixUserEntitie")]
    partial class buildfixUserEntitie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopStyle.Domain.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TopStyle.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TopStyle.Domain.Entities.OrderDetail", b =>
                {
                    b.HasOne("TopStyle.Domain.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TopStyle.Domain.Entities.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("TopStyle.Domain.Entities.Product", b =>
                {
                    b.HasOne("TopStyle.Domain.Entities.Category", "Category")
                        .WithMany("Products")
